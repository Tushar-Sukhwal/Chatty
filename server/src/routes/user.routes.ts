...
router.get("/get-user-by-username-or-email/:userNameOrEmail", verifyFirebaseToken, UserController.getUserByUserNameOrEmail);

//http://localhost:8000/api/user/add-user-to-friends/friendEmail
router.post("/add-user-to-friends/:friendEmail", verifyFirebaseToken, UserController.addUserToFriends);
